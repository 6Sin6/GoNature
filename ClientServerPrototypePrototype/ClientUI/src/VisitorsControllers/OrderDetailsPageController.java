...
public class OrderDetailsPageController implements Initializable {
    ...
    public void getUpdateBtn(ActionEvent event) throws Exception {
        ...
        Order order = new Order((String) cmbParkName.getValue(), orderNumbertxt.getText(),  new Timestamp(visitationTimetxt.getText()),  NumOfVisitor(numberOfVisitorstxt.getText()), telephoneNumbertxt.getText(),Emailtxt.getText());
