...
public class OrderDetailsPageController implements Initializable {
    ...
    protected void loadOrder(Order o1) {
        ...
        this.lblVisitationTime.setText(Utils.parseVisitTime(order.getVisitationTime()));
        this.lblVisitationDate.setText(Utils.parseVisitDate(order.getVisitationTime()));
