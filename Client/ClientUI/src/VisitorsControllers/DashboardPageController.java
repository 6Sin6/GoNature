...
//            this.performHandshake();
    ...
    private void performHandshake() {
        ...
        if (ClientCommunicator.msg.GetMsgOpcode() == OpCodes.SYNC_HANDSHAKE) {
            return;
        }
    ...
    void getOrderByID(ActionEvent event) throws Exception {
        ...
        if (ClientCommunicator.msg.GetMsgOpcode() != OpCodes.GETORDERBYID || ClientCommunicator.msg.GetMsgData() == null) {
    ...
    void viewALLOrdersAction(ActionEvent event) {
        ...
        if (ClientCommunicator.msg.GetMsgOpcode() == OpCodes.GETALLORDERS) {
            try {
    ...
    private void displayAllOrders(ActionEvent event, FXMLLoader loader) throws Exception {
        ...
        ArrayList<Order> OrderList = (ArrayList<Order>) ClientCommunicator.msg.GetMsgData();
